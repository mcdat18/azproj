...
storage_account_alias = "azproj"

clientID = dbutils.secrets.get(databricks_scope_name, "SPdevADLSGen2AppClient")
tenantID = dbutils.secrets.get(databricks_scope_name, "SPdevADLSGen2AppTenant")
clientSecret = dbutils.secrets.get(databricks_scope_name, "SPdevADLSGen2AppSecret")
